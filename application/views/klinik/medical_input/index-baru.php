    ...
    <div class="col-md-12">
        <div class="panel panel-color panel-success">
            <div class="panel-heading">
                <h3 class="panel-title">Input Medical Tenaga Kerja Baru</h3>
            </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <button id="btn-cari-tknew" type="button" class="btn btn-sm waves-effect waves-light btn-primary"><i class="fa fa-search"></i></button>
                                            </span>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal-content p-0 b-0">
            <div class="panel panel-color panel-success">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Pilih Tenaga Kerja Baru untuk Medical</h3>
                </div>
                <div class="panel-body">
                    <div class="row">
...
<script type="text/javascript">
    var urlDtbaleTKNew  = '<?= base_url() ?>Medical/getDatatableMedicalTKBaru',
        urlGetData      = '<?= base_url() ?>Medical/getDataTKNewByNoReg',
        urlSignature    = '<?= base_url() ?>Medical/signaturePadMedical',
        urlCheckSign    = '<?= base_url() ?>Medical/checkFileExist',
        urlSubmitMedic  = '<?= base_url() ?>Medical/simpanMedicalTKNew';
</script>

<script type="text/javascript" src="<?= base_url()?>assets/app/klinik/medical_input/baru.js"></script>