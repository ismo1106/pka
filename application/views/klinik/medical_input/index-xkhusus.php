    ...
    <div class="col-md-12">
        <div class="panel panel-color panel-danger">
            <div class="panel-heading">
                <h3 class="panel-title">Input Medical Khusus</h3>
            </div>
            <div class="panel-body">
                <div class="row">
                    ...
                    <?php endif; ?>
                    <form id="form-input-medical-khusus" class="form-horizontal" role="form" method="POST" data-parsley-validate>
                        <div>
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <input type="hidden" id="txtInputRegNo" name="txtRegNo" >
                                            <span class="input-group-btn">
                                                <button id="btn-cari-khusus" type="button" class="btn btn-sm waves-effect waves-light btn-primary"><i class="fa fa-search"></i></button>
                                            </span>
                                        </div>
                                    </div>
                                </div>
...
<!-- Modal Select Karyawan Medical Khusus -->
<div id="modal-select-khusus" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="width: 75%">
        <div class="modal-content p-0 b-0">
            <div class="panel panel-color panel-danger">
                <div class="panel-heading">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h3 class="panel-title">Pilih Karyawan untuk Medical Khusus</h3>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-2">
                                <input id="txtFilterByName" name="txtFilterName" type="text" class="form-control input-sm" placeholder="Filter by Name">
                            </div>
                            <div class="col-md-2">
                                <div class="btn-group">
                                    <button id="btnSubmitFilter" type="submit" class="btn btn-primary btn-sm waves-effect waves-light">Filter <i class="fa fa-filter"></i> </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="modal-content-khusus" class="col-md-12">
                            <table id="tbl-select-khusus" class="table table-striped table-hover table-nowrap">
                                <thead>
                                    <tr>
...
<script type="text/javascript">
    var urlDtbaleTKNew  = '<?= base_url() ?>Medical/getDatatableMedicalKaryKhusus',
        urlSendFilter   = '<?= base_url() ?>Medical/setFilterMedicalKhusus',
        urlGetData      = '<?= base_url() ?>Medical/getDataKhususByREGNO',
        urlSignature    = '<?= base_url() ?>Medical/signaturePadMedical',
        urlCheckSign    = '<?= base_url() ?>Medical/checkFileExist',
        urlSubmitMedic  = '<?= base_url() ?>Medical/simpanMedicalKhusus';
</script>

<script type="text/javascript" src="<?= base_url()?>assets/app/klinik/medical_input/khusus.js"></script>