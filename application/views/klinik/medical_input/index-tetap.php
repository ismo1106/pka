    ...
    <div class="col-md-12">
        <div class="panel panel-color panel-purple">
            <div class="panel-heading">
                <h3 class="panel-title">Input Medical Karyawan Tetap</h3>
            </div>
            <div class="panel-body">
                <div class="row">
                    ...
                    <?php endif; ?>
                    <form id="form-input-medical-tetap" class="form-horizontal" role="form" method="POST" data-parsley-validate>
                        <div>
                            <div class="col-md-5">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <button id="btn-cari-tetap" type="button" class="btn btn-sm waves-effect waves-light btn-primary"><i class="fa fa-search"></i></button>
                                            </span>
                                        </div>
                                    </div>
                                </div>
...
<!-- Modal Select Kary. Tetap Medical -->
...
<script type="text/javascript">
    var urlDtbaleTKNew  = '<?= base_url() ?>Medical/getDatatableMedicalKaryTetap',
        urlGetData      = '<?= base_url() ?>Medical/getDataTetapByNIK',
        urlSignature    = '<?= base_url() ?>Medical/signaturePadMedical',
        urlCheckSign    = '<?= base_url() ?>Medical/checkFileExist',
        urlSubmitMedic  = '<?= base_url() ?>Medical/simpanMedicalTetap';
</script>

<script type="text/javascript" src="<?= base_url()?>assets/app/klinik/medical_input/tetap.js"></script>