    ...
    <div class="col-md-12">
        <div class="panel panel-color panel-teal">
            <div class="panel-heading">
                <h3 class="panel-title">Input Surat Sakit Borongan/Harian</h3>
            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="txtInputNIK" name="txtNIK" class="form-control input-sm" placeholder="Search">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
...
<script type="text/javascript">
    var urlSubmit   = '<?=  base_url()?>SuratSakit/simpanSuratSakitBorongan',
        urlGetData  = '<?=  base_url()?>SuratSakit/getDataBoronganByNIK',
        urlCekData  = '<?=  base_url()?>SuratSakit/checkSuratSakit';
</script>
<script type="text/javascript" src="<?= base_url()?>assets/app/klinik/surat_sakit/input_borongan/index.js"></script>