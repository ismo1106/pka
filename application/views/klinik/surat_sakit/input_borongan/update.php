    ...
    <div class="col-md-12">
        <div class="portlet">
            <div class="portlet-heading bg-teal">
                <h3 class="portlet-title">Update Surat Sakit Borongan/Harian</h3>
            ...
            <div id="bg-primary" class="panel-collapse collapse in">
                <div class="portlet-body">
                    <div class="row">
                        ...
                        <?php endif; ?>
                        <form id="form-input-susak-borongan" class="form-horizontal" role="form" method="POST" data-parsley-validate>
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input id="txtInputJabatan" name="txtJabatan" type="text" required class="form-control input-sm" value="<?= $rM->Jabatan?>" readonly="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <hr style="border:0;height:2px;background-image:linear-gradient(to right,#26a69a,#4bd396,rgba(0,0,0,0));">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <select id="selInputJenisSurat" name="selJenisSurat" class="form-control input-sm">
                                                ...
                                                <option value="ikd" <?= ($rS->JenisSurat == 'iks'? 'selected': '')?>>Keterangan Dokter</option>
                            ...
                            <div class="col-md-12">
                                <hr style="border:0;height:2px;background-image:linear-gradient(to right,rgba(0,0,0,0),#4bd396,#26a69a);">
                                <div class="col-sm-6">
...
<script type="text/javascript">
    var urlSubmit   = '<?= base_url()?>SuratSakit/updateSuratSakitBorongan',
        urlCekData  = '<?= base_url()?>SuratSakit/checkSuratSakitForUpdate',
        valJnsSrat  = '<?= $rS->JenisSurat?>';
</script>
<script type="text/javascript" src="<?= base_url()?>assets/app/klinik/surat_sakit/input_borongan/update.js"></script>