...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Monitoring Oleh P2K3</h4>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div id="pnl-mss" class="panel panel-color panel-<?= rand_color()?>" >
            <div class="panel-heading">
                <h3 class="panel-title">Surat Sakit telah disetujui</h3>
            </div>
            <div class="panel-body">
                <div class="row">
                    ...
                    <form id="form-check-susak-p2k3" method="POST">
                        <div class="col-md-12">
                            <hr class="hrLineBatas" style="border:0;height:2px;">
                        </div>
                        <div class="col-sm-12">
                            <table id="tbl-p2k3-susak" class="table table-striped table-hover table-nowrap table-colored table-<?= rand_color()?>">
                                <thead>
                                    <tr>
...
<script type="text/javascript">
    var urlDtable   = '<?= base_url()?>SuratSakitMonitor/getDatatableCheckP2K3',
        urlChecked  = '<?= base_url()?>SuratSakitMonitor/checkedP2K3';
</script>

<script type="text/javascript" src="<?= base_url()?>assets/app/klinik/monitor/surat_sakit_monitor/p2k3.js"></script>