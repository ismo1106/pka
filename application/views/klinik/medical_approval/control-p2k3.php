...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Control Medical Oleh P2K3</h4>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="panel panel-color panel-<?= rand_color()?>">
            <div class="panel-heading">
                <h3 class="panel-title">Medical yang telah disetujui</h3>
            </div>
            <div class="panel-body">
                <div class="row">
                    ...
                    <?php endif; ?>
                    <form id="form-control-medical-p2k3" method="POST">
                        <div class="col-sm-12">
                            <table id="tbl-control-medical-p2k3" class="table table-striped table-hover table-nowrap table-colored table-<?= rand_color()?>">
                                <thead>
                                    <tr>
                                        <th class="">
                        ...
                        <div class="col-sm-12 text-center">
                            <button id="btnCheckedP2K3" type="button" class="btn btn-sm btn-success waves-effect waves-light">
...
<script type="text/javascript">
    var urlDtbale   = '<?= base_url() ?>MedicalApproval/getDatatableMedicalControlP2K3',
        urlInfoMed  = '<?= base_url() ?>MedicalApproval/getInfoMedical',
        urlCheckByOne   = '<?= base_url() ?>MedicalApproval/checkedP2K3MedicalOneByOne',
        urlCheckMulti   = '<?= base_url() ?>MedicalApproval/checkedP2K3MedicalMulti';
</script>
