...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Approval Medical</h4>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="panel panel-color panel-<?= rand_color()?>">
            <div class="panel-heading">
                <h3 class="panel-title">Approval Medical</h3>
            </div>
            <div class="panel-body">
                <div class="row">
                    ...
                    <?php endif; ?>
                    <form id="form-approve-medical" method="POST">
                        <div class="col-sm-12">
                            <table id="tbl-approval-medical" class="table table-striped table-hover table-nowrap table-colored table-<?= rand_color()?>">
                                <thead>
                                    <tr>
                                        <th class="">
...
<script type="text/javascript">
    var urlDtbale   = '<?= base_url() ?>MedicalApproval/getDatatableApprovalMedical',
        urlUpMedic  = '<?= base_url() ?>Medical/updateMedical',
        urlApprByOne= '<?= base_url() ?>MedicalApproval/acceptMedicalOneByOne',
        urlApprMulti= '<?= base_url() ?>MedicalApproval/acceptMedicalMulti',
