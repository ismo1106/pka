...
jQuery(document).ready(function () {
    ...
    $('#btnChecked').click(function (){
        $("#form-check-susak-p2k3").attr('action', urlChecked);
        swal({
            ...
            if (isConfirm) {
                $("#form-check-susak-p2k3").submit();
            }
            $("#form-check-susak-p2k3").attr('action', "");
        });
    });
});
